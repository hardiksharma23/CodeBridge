...
const ProjectDetails = () => {
  ...
  return (
    <div className="flex flex-col w-11/12 max-w-[1260px] mx-auto p-8 bg-gray-900 rounded-lg shadow-lg text-white mt-32 mb-10">
      <h1 className="flex justify-center font-serif text-4xl font-bold mb-6 items-center">{project.projectName}</h1>
      
      <div className="flex flex-col sm:flex-row gap-6">
        <div className="w-full sm:w-1/2 mt-3 mb-3">
          <img
            src={project.thumbnail}
            alt="Project Thumbnail"
            className="mb-6 rounded-md shadow-md w-full h-auto"
          />
        </div>
        ...
        <div className="w-full sm:w-1/2 mt-3 mb-3">
          ...
          <div className="mb-4">
            ...
            <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline ml-1 break-words break-all">
              {project.githubUrl}
            </a>
          </div>
        </div>
