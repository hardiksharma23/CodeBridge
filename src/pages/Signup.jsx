            ...
            {loading ? (
                ...
                <div className="relative flex flex-col w-full max-w-md p-8 space-y-8 rounded-3xl backdrop-blur-xl bg-gray-800/70 border border-gray-700 shadow-2xl shadow-emerald-900/30">
                    <div className="text-center">
                        <h2 className="mt-6 text-4xl font-extrabold bg-gradient-to-r from-emerald-400 to-green-500 bg-clip-text text-transparent">
                            Create Account
                        </h2>
                    ...
                    <form onSubmit={handleOnSubmit} className="mt-8 space-y-6">
                        ...
                        <button
                            type="submit"
                            className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-emerald-600 hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-all transform hover:scale-[1.02] active:scale-95"
                        >
                            Create Account
                        </button>
                    </form>
